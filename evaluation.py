...
def model_eval_multitask(sentiment_dataloader,
    ...
    with torch.no_grad():
        ...
        sentiment_accuracy, paraphrase_accuracy, sts_corr = None, None, None

        sst_y_true = []
        sst_y_pred = []
        sst_sent_ids = []
        if sentiment_dataloader is not None:
        ...
        para_y_pred = []
        para_sent_ids = []
        if paraphrase_dataloader is not None:
        ...
        if paraphrase_accuracy is not None:
